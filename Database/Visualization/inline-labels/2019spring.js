...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["Spring2019Attendance.txt",new URL("./files/Spring2019Attendance.txt",import.meta.url)]]);
...
d3.tsvParse(await FileAttachment("Spring2019Attendance.txt").text(), d => (d3.autoType(d).date = new Date(d.date), d))
)});
