...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["all.txt",new URL("./files/all.txt",import.meta.url)]]);
...
d3.tsvParse(await FileAttachment("all.txt").text(),d => (d3.autoType(d).date = d.meeting_number, d))
)});
